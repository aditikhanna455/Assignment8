...
mongoose.connect('mongodb+srv://aditi_17:AditiKhanna1717@cluster0.nsfas.mongodb.net/reception-db')
.then(()=>{
...
function sendemail(email,cinh,cinm){
   ...
   const  sendgrid='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';
  ...
  const msg={
      to: email,
      from: "aditi0373.cse19@chitkara.edu.in",
